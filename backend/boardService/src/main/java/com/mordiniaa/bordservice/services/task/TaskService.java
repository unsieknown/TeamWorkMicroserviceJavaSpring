...
import com.mordiniaa.bordservice.mappers.task.TaskMapper;
...
import com.mordiniaa.bordservice.repositories.board.aggregation.returnTypes.TaskCreatorProjectionWithOptPosition;
...
public class TaskService {
    ...
    protected TaskDetailsDTO detailedTaskDto(Task task, Set<UUID> userIds) {
        ...
        Map<UUID, UserDto> users = userServiceInter.batchUsers(userIds)
                .stream()
